...
<head>
    ...
    <script>
        $(function () {
            ...
            //通过js创建datagrid
            $("#dg").datagrid({
                url:'${pageContext.request.contextPath}/panel/findAll',//用来请求远程数据
        ...
        function delRow(id){
           //获取当前点击id发送ajax请求删除id这个人的信息
            $.post("/user/delete",{"id":id},function (result) {//响应成功之后回调
                //刷新datagrid数据
                $("#dg").datagrid('reload');//刷新当前datagrid
            });
        }
...
<body>
    ...
    <%--保存用户对话框--%>
    <div id="saveUserDialog" data-options="href:'${pageContext.request.contextPath}/datagrid/save.jsp',draggable:false,iconCls:'icon-save',width:600,height:400,title:'保存用户信息'">
